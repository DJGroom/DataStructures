...
private:
    ...
    // This pointer identifies the "top" node, i.e., the one most recently allocated.
    NodeType*  topNode;

    // A pointer to the location of the next item to be returned
...
public:
    ...
    void SplitList(UnsortedList &splitlist1, UnsortedList &splitlist2, ItemType item);
